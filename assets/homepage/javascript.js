...
packages = decodePackagesFile(loadXMLDoc("https://godlike5.github.io/Packages"))
...
for (i = 0; i < packages.length; i++) {
    ...
    if (packages[i].hasOwnProperty("SileoDepiction")) {
        a.href = "https://godlike5.github.io/Sileo-Depiction-WebViews/"
                    + "?json="      + packages[i].SileoDepiction
                    + "&name="      + packages[i].Name
                    + "&section="   + packages[i].Section
                    + "&dev="       + packages[i].Author
                    + "&icon="      + "https://godlike5.github.io/assets/page-icons/" + (packages[i].Name).replace(/ |-|:|;/g, "").toLowerCase() + ".png"
